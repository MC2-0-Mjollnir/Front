            ...
            <div className="flex flex-col gap-4 w-full">
                ...
                <div className="w-full flex flex-col justify-center">
                    <div className="w-full flex items-center justify-between">
                        ...
                        <Link to={'/auth/reset-password'} className="underline hover:no-underline">Reset password?</Link>
                    </div>
                ...
                <button type="submit" className="cursor-pointer transition-all flex items-center justify-center hover:bg-white hover:text-mainColor border border-transparent hover:border-mainColor px-3 py-4 w-full mt-4 text-white font-unbounded bg-mainColor">
                    {
                        !isLoading ? 'Login' : <Spinner style={{height: "28px", width: "28px"}} color='white' />
                    }
                </button>
                <h4 className="text-center">You don’t have an account? <Link to='/auth/register' className="hover:underline">Register!</Link></h4>
            </div>
        </form>
    )
}
